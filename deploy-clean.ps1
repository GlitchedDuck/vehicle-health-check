...
$Branch   = "main"
$ZipPath  = "$env:USERPROFILE\Downloads\drivewell-platform-v8-clean.zip"
...
Write-Host " DriveWell v8 - CLEAN GitHub Deployment" -ForegroundColor Cyan
Write-Host "====================================================" -ForegroundColor Cyan
Write-Host ""
...
if (-not (Test-Path $ZipPath)) {
    ...
    Write-Host "  $ZipPath"
    Write-Host "Download drivewell-platform-v8-clean.zip into Downloads first."
    exit 1
}
...
Write-Host "[2/7] Extracting DriveWell v8..." -ForegroundColor Yellow
try {
...
Write-Host "[5/7] Copying clean DriveWell v8 snapshot..." -ForegroundColor Yellow
...
git commit -m "Clean rebuild: DriveWell v8 premium service assemblies"
if ($LASTEXITCODE -ne 0) {
...
Write-Host " DRIVEWELL V8 DEPLOYED" -ForegroundColor Green
Write-Host "====================================================" -ForegroundColor Green
Write-Host ""
Write-Host "Live site:"
Write-Host "https://glitchedduck.github.io/vehicle-health-check/?drivewell=v8"
Write-Host ""
