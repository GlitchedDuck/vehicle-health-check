...
$Branch   = "main"
$ZipPath  = "$env:USERPROFILE\Downloads\drivewell-platform-v5b-clean.zip"
...
Write-Host " DriveWell v5b - CLEAN GitHub Deployment" -ForegroundColor Cyan
Write-Host "====================================================" -ForegroundColor Cyan
Write-Host ""
...
if (-not (Test-Path $ZipPath)) {
    ...
    Write-Host "  $ZipPath"
    Write-Host "Download drivewell-platform-v5b-clean.zip into Downloads first."
    exit 1
}
...
git commit -m "Clean rebuild: DriveWell premium v5b grounding fix"
if ($LASTEXITCODE -ne 0) {
...
Write-Host " DRIVEWELL V5B DEPLOYED" -ForegroundColor Green
Write-Host "====================================================" -ForegroundColor Green
Write-Host ""
Write-Host "Live site:"
Write-Host "https://glitchedduck.github.io/vehicle-health-check/?drivewell=v5b"
Write-Host ""
